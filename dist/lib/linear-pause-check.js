...
export function createLinearPauseChecker(opts) {
...
export function maybeCreateLinearPauseChecker(config, env = process.env) {
    const apiKey = env.LINEAR_API_KEY;
    if (!apiKey || !config.linear_team)
        return undefined;
    return createLinearPauseChecker({ apiKey, teamKey: config.linear_team });
}
//# sourceMappingURL=linear-pause-check.js.map