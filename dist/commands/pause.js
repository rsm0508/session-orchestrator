...
export default class Pause extends Command {
    static description = 'Create the repo-level kill-switch file (.session-orchestrator-paused). Stops future runs in this repo.';
    static examples = [
    ...
    async run() {
        ...
        this.log('Future runs in this repo are halted. The env var and Linear-label paths are independent — flip them separately if needed.');
    }
}
